...
// Fetch projects assigned to this employee with filters
try {
    $query = "
        SELECT p.*, 
               CONCAT(m.first_name, ' ', m.last_name) as manager_name,
               d.dept_name,
               COUNT(DISTINCT pa2.emp_id) as team_size,
...
<head>
    ...
    <title>My Projects - Employee Dashboard</title>
...
.page-header {
    ...
    .modal-header {
    /* Use default Bootstrap modal header styles */
...
<body>
  ...
  <div>
    ...
    <div class="text-muted" style="font-size: 1.1rem;">Track and manage your assigned projects</div>
  </div>
</div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="project-card">
                                ...
                                <div class="project-body">
                                    <div class="project-info">
                                        <div class="project-info-item">
                                            ...
                                            <span>Manager: <?php echo htmlspecialchars($project['manager_name']); ?></span>
                                        </div>
                                        <div class="project-info-item">
                                ...
                                <div class="project-actions">
                                    <button class="btn btn-sm btn-info w-100" onclick="viewProject(<?php echo htmlspecialchars(json_encode($project)); ?>)">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="project-info-item">
                                <i class="fas fa-user"></i>
                                <span>Manager: <span id="view_manager_name"></span></span>
                            </div>
                            <div class="project-info-item">
                                <i class="fas fa-calendar-alt"></i>
